...
namespace TrainSMARTApp
{
    public partial class MainForm: Form
    {
        ...
        private void cuiButton_WorkoutTemplate_GoBack_Click(object sender, EventArgs e)
        {
            ...
            isViewingWorkoutTemplate = false;
            if (panel_WorkoutTemplate_Title.Tag is false)
        ...
        private void LoadTemplateExercises(FlowLayoutPanel flowLayoutPanel, int selectedTemplateId, bool isPrebuilt)
        {
            ...
            cuiButton_WorkoutTemplate_AddExercise.Visible = !isPrebuilt;
        }
        ...
        private bool DeleteWorkoutTemplate(int selectedTemplateId)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    // 0. Set TemplateID to NULL in Workouts that use this template
                    string nullifyTemplateIdQuery = @"
                        UPDATE Workouts
                        SET TemplateID = NULL
                        WHERE TemplateID = @TemplateID";
                    SqlCommand cmdNullify = new SqlCommand(nullifyTemplateIdQuery, conn, transaction);
                    cmdNullify.Parameters.AddWithValue("@TemplateID", selectedTemplateId);
                    cmdNullify.ExecuteNonQuery();
        ...
        private Panel CreateExercisePanel(int exerciseId, string exerciseName, bool isPrebuilt)
        {
            ...
            cuiButton_WorkoutTemplate_AddExercise.Visible = false;
        ...
        private cuiButton CreateTemplateButton(object templateId, string templateName, string note, bool isPrebuilt, string historyDetails = "")
        {
            ...
            btnTemplate.Click += (s, _) =>
            {
                ...
                panel_WorkoutTemplate_Title.Tag = isPrebuilt;       // TODO: enahcne
